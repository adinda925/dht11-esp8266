...
const char* ssid = "paketannya abis";             // The SSID (name) of the WiFi network you want to connect to
const char* password = "susahwifinya057274";      // The password of the WiFi network
